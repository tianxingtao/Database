...
<body>
    <h1>公司注册</h1>
	<div id="regist-main">
		<form id="registForm" action="${pageContext.request.contextPath}/productinfo/registercid" method="post">
			<ol>
				<li><label for="uname"> </label>
				<li><label for="uname"> </label>
				<li><label for="uname">公司名： <span
				...
				<li><label for="passwd">密码： <span
					...
					type="password"></li>
				  <li><label for="passwd">公司地址： 
				  </label>  <input id="passwd" name="address"></li>
				  <li><label for="passwd">公司电话： 
