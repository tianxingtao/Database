...
<body>
    <h1>公司注册</h1>
	<div id="regist-main">
		<form id="registForm" action="${pageContext.request.contextPath}/productinfo/registeruid" method="post">
			<ol>
				...
				<li><label for="uname">用户名： <span
					...
					data-valmsg-replace="true"></span> <input id="uname" name="uid"
					type="text" value=""></li>
				<li><label for="passwd">密码： <span
					...
					type="password"></li>
					<li><label for="passwd">性别： 
				  </label>  <input id="passwd" name="type"></li>\
				  <li><label for="passwd">电话： 
				  </label>  <input id="passwd" name="phone"></li>
			</ol>
